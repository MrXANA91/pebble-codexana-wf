...
#define TIME_TEXT_HEIGHT_OFFSET  15
...
#define GRect_DHours(bounds) GRect(bounds.origin.x, bounds.origin.y + bounds.size.h / 4 - TIME_TEXT_HEIGHT_OFFSET, bounds.size.w / 2, bounds.size.h / 4 + TIME_TEXT_HEIGHT_OFFSET)
#define GRect_Hours(bounds) GRect(bounds.origin.x + (bounds.size.w / 2), bounds.origin.y + bounds.size.h / 4 - TIME_TEXT_HEIGHT_OFFSET, bounds.size.w / 2, bounds.size.h / 4 + TIME_TEXT_HEIGHT_OFFSET)
#define GRect_DMinutes(bounds) GRect(bounds.origin.x, bounds.origin.y + (bounds.size.h / 2) - TIME_TEXT_HEIGHT_OFFSET, bounds.size.w / 2, bounds.size.h / 4 + TIME_TEXT_HEIGHT_OFFSET)
#define GRect_Minutes(bounds) GRect(bounds.origin.x + (bounds.size.w / 2), bounds.origin.y + (bounds.size.h / 2) - TIME_TEXT_HEIGHT_OFFSET, bounds.size.w / 2, bounds.size.h / 4 + TIME_TEXT_HEIGHT_OFFSET)
